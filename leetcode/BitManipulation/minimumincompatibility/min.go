package minimumincompatibility
...
func minimumIncompatibility(nums []int, k int) int {
	...
	sort.Ints(orders)
	res := math.MaxInt32
	generatePermutation(nums, counts, orders, 0, 0, eachSize, &res, []int{})
...
func generatePermutation(nums, counts, order []int, index, sum, eachSize int, res *int, current []int) {
